          ...
          <div class="x_content">
            ...
            <form action="../netting/adminislem.php" method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">,
                <label class="control-label col-md-3 col-sm-3 col-xs-3" for="first-name">Yüklü Logo<span class="required">*</span>
                  <br>
                </label>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="file" id="logo" name="ayar_logo" class="form-control col-md-7 col-xs-12">
