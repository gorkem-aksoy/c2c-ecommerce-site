    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div align="right">
            <a href="menu-ekle.php"><button class="btn btn-dark btn-xs">Yeni Ekle</button></a>
          </div>
          <div class="x_content">
              ...
              <tbody>
                ...
                while($menucek=$menusor->fetch(PDO::FETCH_ASSOC)) { $say++?>
                  ...
                  <tr>
                   ...
                   <td width="25"><?php echo $menucek['menu_sira'] ?></td>
                  ...
                  <td><center><a href="../netting/adminislem.php?menu_id=<?php echo $menucek['menu_id']; ?>&menusil=ok"><button class="btn btn-danger btn-xs">Sil</button></a></center></td>
                </tr>
