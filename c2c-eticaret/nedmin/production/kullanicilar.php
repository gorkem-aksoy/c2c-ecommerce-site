            ...
            <tbody>
              ...
              while($kullanicicek=$kullanicisor->fetch(PDO::FETCH_ASSOC)) {?>
                ...
                <tr>
                  ...
                  <td><center><a href="kullanici-bilgileri.php?kullanici_id=<?php echo $kullanicicek['kullanici_id']; ?>"><button class="btn btn-primary btn-xs">Detay</button></a></center></td>
                  
                  <td><center><a href="../netting/adminislem.php?kullanici_id=<?php echo $kullanicicek['kullanici_id']; ?>&kullanicisil=ok"><button class="btn btn-danger btn-xs">Sil</button></a></center></td>
                </tr>
