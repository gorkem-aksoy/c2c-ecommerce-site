    ...
    <div class="login_wrapper">
      <div class="animate form login_form">
        <section class="login_content">
          ...
          <form action="../netting/procedur.php" method="POST">
            ...
            <div>
              <button style="width: 100%; background-color: #73879C; color:white;" type="submit" name="kullaniciadmingiris" class="btn btn-default"> Giriş Yap</button>
            ...
            <div class="separator">
             ...
             <div>
              <h1><i class="fa fa-paw"></i> C2c Pazarlama</h1>
              <p>©2022 Görkem Aksoy</p>
            </div>
          </div>
        </form>
