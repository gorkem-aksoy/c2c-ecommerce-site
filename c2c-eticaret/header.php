...
if (isset($_SESSION['userkullanici_mail'])) {
 ...
 $kullanicisor->execute(array(
    ...
    // Sorgu başarıyla çalıştı, sonuçları almak için devam edin
 $say = $kullanicisor->rowCount();
 $kullanicicek = $kullanicisor->fetch(PDO::FETCH_ASSOC);

 //kullanici id tanımlama
                                                 ...
                                                 <div class="apply-btn-area">
                                                    ...
                                                    <div class="login-form" id="login-form" style="display: none;">
                                                        ...
                                                        <form action="nedmin/netting/procedur.php" method="POST">
                                                            ...
                                                            <input class="form-control" name="kullanici_mail" type="text" placeholder="Mail Adresiniz...">
                                                            <input class="form-control" name="kullanici_password" type="password" placeholder="Şifreniz...">


                                                            <button class="btn-login" name="kullanicigiris" type="submit" value="Giriş Yap">Giriş Yap</button>
                                                            <a class="btn-login" href="register">Kayıt OL</a>
                                                ...
                                                <div class="user-account-info">
                                                    <div class="user-account-info-controler">
                                                        <div class="user-account-img">
                                                            <img style="margin-bottom: 4px; border-radius: 40px;" width="34" class="img-responsive" src="<?php echo $kullanicicek['kullanici_resim'] ?>" alt="profile">
                                                        </div>
                                                    ...
                                                    <ul>
                                                        ...
                                                        if ($kullanicicek['kullanici_magaza']==2) {?>
                                                             <li><a href="magaza-<?=seo($kullanicicek['kullanici_magazatakmaad']." ".$kullanicicek['kullanici_id']) ?>">Mağazanız</a></li>
                                                         <?php } ?>
