                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $siparissor=$db->prepare("SELECT siparis.*,siparis_detay.* FROM siparis INNER JOIN siparis_detay ON siparis.siparis_id=siparis_detay.siparis_id where siparis.kullanici_idsatici=:kullanici_idsatici and siparis_detay.siparisdetay_onay=:onay or siparis_detay.siparisdetay_onay=:onayd order by siparis_zaman DESC");
                                        ...
                                        while($sipariscek=$siparissor->fetch(PDO::FETCH_ASSOC)) { $say++?>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="yeni-siparis-detay?siparis_id=<?php echo $sipariscek['siparis_id'] ?>"><button class="btn btn-primary btn-xs">Detay</button></a></td>
