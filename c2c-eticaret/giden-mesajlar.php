                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $mesajsor=$db->prepare("SELECT mesaj.*,kullanici.* FROM mesaj INNER JOIN kullanici ON mesaj.kullanici_alan=kullanici.kullanici_id where mesaj.kullanici_gonderen=:kullanici_gonderen order by mesaj_okunma,mesaj_zaman DESC");
                                        ...
                                        while($mesajcek=$mesajsor->fetch(PDO::FETCH_ASSOC)) { $say++?>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="gidenmesaj-detay?mesaj_id=<?php echo $mesajcek['mesaj_id'] ?>"><button class="btn btn-primary btn-xs">Detay</button></a></td>

                                                <td><a onclick="return confirm('Bu mesajı silmek istiyormusunuz? \n İşlem geri alınamaz...')" href="nedmin/netting/islem.php?gidenmesajsil=ok&mesaj_id=<?php echo $mesajcek['mesaj_id'] ?>"><button class="btn btn-danger btn-xs">Sil</button></a></td>
