    ...
    <div class="container">
        <div class="pagination-wrapper">
            <ul>
                ...
                <li style="color:#263238;"><b>Şifre Ayarları</b></li>
            </ul>
        </div>
    </div>  
</div> 
               ...
               if (isset($_GET['durum'])) {
                ...
                <?php } elseif ($_GET['durum']=="sifredegisti") {?>
                    ...
                    <div class="alert alert-success">
                        ...
                        <span class="
                        glyphicon glyphicon-ok-sign" aria-hidden="true"></span>
                        Şifre değiştirme işleminiz başarıyla gerçekleştirilmiştir.
                    </div>

                <?php } elseif ($_GET['durum']=="sifredegismedi") {?>

                    <div class="alert alert-danger">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
                        Şifre değiştirme işleminiz başarısız!
                    </div>
                ...
                <?php } elseif ($_GET['durum']=="farklisifre") {?>
                    ...
                    <div class="alert alert-danger">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
                        Yeni şifreniz birbiri ile uyuşmuyor!
                    </div>
                    ...
                    <div class="tab-pane fade active in" id="Password">
                        ...
                        <div class="personal-info inner-page-padding"> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" name="kullanici_passwordold" id="first-name" type="password">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" name="kullanici_passwordone" id="first-name" type="password">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9"> 
                                    <input class="form-control" name="kullanici_passwordtwo" id="last-name" type="password">
                                </div>
                            </div>
